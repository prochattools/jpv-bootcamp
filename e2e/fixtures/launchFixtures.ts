...
export function portalPageHtml(section: 'home' | 'billing-checkout' | 'billing-active' | 'account' | 'referral' | 'support'): string {
  const content = {
    ...
    'billing-checkout': '<h1>Billing</h1><p>Choose a supported JPV Bootcamp Membership option.</p><button data-billing="monthly">£80/month</button><button data-billing="annual">£800/year</button><p>No minimum commitment.</p><section><h2>Billing projection summary</h2><p>Projected plan: No active membership</p></section>',
    'billing-active': '<h1>Billing</h1><p>Manage your subscription, invoices, and payment methods through our secure billing portal.</p><section><h2>Subscription status</h2><p>Current plan</p><p>JPV Bootcamp Membership</p><p>Billing cadence</p><p>Monthly billing</p><p>Renewal state</p><p>Active</p></section><section><h2>Manage subscription</h2><button type="button">Manage billing</button><button type="button">Request end-of-term cancellation</button></section><section><h2>Billing projection summary</h2><p>Projected plan: JPV Bootcamp Membership</p><p>Projected subscription status: Active</p></section>',
    account: '<h1>Account</h1><p>Manage your member profile.</p><section><h2>Profile</h2><label>Display name<input name="displayName" type="text" /></label><button type="button">Save profile</button></section><section><h2>Security</h2><label>Current password<input name="currentPassword" type="password" /></label><label>New password<input name="newPassword" type="password" /></label><button type="button">Change password</button></section><section><h2>Change email address</h2><label>New email address<input name="newEmail" type="email" /></label><button type="button">Request email change</button></section><section><h2>Membership</h2><p>JPV Bootcamp Membership</p></section><section><h2>Access groups</h2><p>Course members</p></section><section><h2>Billing projection</h2><p>Status: Active</p></section>',
    ...
    support: '<h1>Support and pay-it-forward access</h1><div class="notice">Preview only — these forms do not submit, create records, send notifications, generate references, or grant access.</div><form aria-label="Pay-it-forward membership application preview"><label>Reason<textarea disabled></textarea></label><button disabled>Application unavailable in preview</button></form>',
  }[section]
