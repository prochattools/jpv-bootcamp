...
assert.match(portalLayout, /forcedTheme='light'/)
assert.match(portalLayout, /storageKey='jpv-portal-theme'/)
assert.match(portalLayout, /showThemeToggle=\{isAuthenticated\}/)
assert.match(providers, /useSearchParams/)
assert.match(providers, /isPortalLogin/)
...
assert.match(portalShell, /storageKey='jpv-portal-theme'/)
