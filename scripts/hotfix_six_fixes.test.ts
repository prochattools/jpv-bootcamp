...
assert.match(support, /parseConfiguredEmailRecipients/)
assert.match(support, /SUPPORT_NOTIFIER/)
assert.doesNotMatch(support, /getPayloadAdministratorRecipients/)
...
assert.match(sponsored, /parseConfiguredEmailRecipients/)
assert.match(sponsored, /SUPPORT_NOTIFIER/)
assert.doesNotMatch(sponsored, /getPayloadAdministratorRecipients/)
