...
assert.match(readiness, /account-action hardening.*complete in source|ACCOUNT-ACTION HARDENING IMPLEMENTED LOCALLY/i)
assert.match(readiness, /Production migration is NOT authorized|STAGING MIGRATION AUTHORIZATION REQUIRED|shared staging.*pending/i)
