...
function main(): void {
  ...
  assert.match(previewReadiness, /pnpm test:release.*127\/127/i)
  ...
  assert.match(operatorHandoff, /Deterministic non-browser release gate: `pnpm test:release` \(`127\/127`\)/)
