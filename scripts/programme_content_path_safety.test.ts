...
function main(): void {
  ...
  assert.throws(() => resolveProgrammeContentPath('docs/client/JPV_Bootcamp_Platform_Expansion_Go_Live_Plan_v3_5.docx'), /Only \.json programme content files are supported/)
