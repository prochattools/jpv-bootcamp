...
const persistence = read('src/lib/support/persistence.ts')
...
assert.match(persistence, /prisma\.supportRequest\.create/)
assert.match(persistence, /prisma\.supportRequest\.update/)
...
assert.match(inbox, /listSupportRequests/)
assert.match(inbox, /setSupportReviewStatus/)
assert.match(persistence, /prisma\.supportRequest\.findMany/)
assert.match(persistence, /reviewedByAccountId/)
...
assert.match(inbox, /request\.phone/)
assert.match(inbox, /Back to Payload dashboard/)
