...
test('canonical registry is ordered, unique, and has the reviewed 47 names', () => {
  ...
  assert.equal(PAYLOAD_MIGRATION_NAMES.at(-1), '20260826_090000_payment_action_required_status')
})
