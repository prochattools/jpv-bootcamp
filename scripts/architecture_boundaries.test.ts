...
function assertExactCounts(
  ...
  const normalized = (value: Record<string, number>) => JSON.stringify(Object.entries(value).sort(([a], [b]) => a.localeCompare(b)))
...
const privilegedOverrideCounts: Record<string, number> = {
  ...
  'src/app/(frontend)/portal/community/[spaceSlug]/page.tsx': 5,
  'src/app/(frontend)/portal/community/[spaceSlug]/posts/[postId]/page.tsx': 5,
  'src/app/(frontend)/portal/community/actions.ts': 2,
  ...
  'src/app/(frontend)/portal/rooms/[roomId]/page.tsx': 1,
  'src/app/(frontend)/portal/rooms/actions.ts': 5,
  'src/app/(frontend)/portal/rooms/page.tsx': 2,
  ...
  'src/app/api/bunny/video/route.ts': 5,
  'src/app/api/community/files/route.ts': 5,
  'src/app/api/portal/announcements/media/route.ts': 1,
  'src/app/api/portal/announcements/route.ts': 2,
  'src/app/api/portal/bookmarks/route.ts': 1,
  'src/app/api/portal/community/comments/route.ts': 3,
  'src/app/api/portal/community/posts/delete/route.ts': 3,
  'src/app/api/portal/courses/[courseSlug]/lessons/[lessonSlug]/comments/route.ts': 1,
  'src/app/api/portal/members/[memberId]/follow/route.ts': 1,
  'src/app/api/portal/notifications/route.ts': 12,
  'src/app/api/portal/rooms/[id]/route.ts': 1,
  'src/app/api/portal/rooms/route.ts': 2,
  'src/app/api/sponsored-applications/decision/route.ts': 1,
  'src/app/api/webhook/bunny/route.ts': 5,
  'src/collections/PayloadLiveSession.ts': 3,
  ...
  'src/lib/auth/resolvePortalRequestMember.ts': 3,
  'src/lib/payloadContent/announcements.ts': 4,
  'src/lib/payloadContent/audience.ts': 2,
  ...
  'src/lib/payloadCourse/adminRecipients.ts': 1,
  'src/lib/payloadCourse/affiliateReporting.ts': 4,
  'src/lib/payloadCourse/bookmarks.ts': 4,
  ...
  'src/lib/payloadCourse/reactions.ts': 11,
  'src/lib/payloadCourse/reconcileEntitlements.ts': 1,
  'src/lib/payloadCourse/resourceLibrary.ts': 1,
  ...
  'src/lib/portalAdmin/announcementCommands.ts': 6,
  'src/lib/portalAdmin/memberGroupCommands.ts': 10,
  'src/lib/rooms/audience.ts': 10,
  'src/lib/rooms/livekitAuthorization.ts': 3,
  'src/lib/rooms/roomAccess.ts': 10,
  'src/lib/rooms/roomCommands.ts': 11,
  'src/lib/rooms/roomNotifications.ts': 3,
  'src/lib/rooms/roomQueries.ts': 3,
