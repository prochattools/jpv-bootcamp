...
const privilegedOverrideCounts: Record<string, number> = {
  ...
  'src/app/(frontend)/portal/rooms/page.tsx': 3,
  ...
  'src/lib/portalAdmin/memberGroupCommands.ts': 9,
  'src/lib/rooms/audience.ts': 6,
  'src/lib/rooms/livekitAuthorization.ts': 1,
  'src/lib/rooms/roomAccess.ts': 9,
