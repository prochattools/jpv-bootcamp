...
async function main(): Promise<void> {
  ...
  assert.match(docs.roadmap, /34398931497/)
  assert.match(docs.roadmap, /a287800735d465a41ad9e45d2c7914ab9cc34a26/)
  ...
  assert.match(docs.operatorHandoff, /34398931497/)
  assert.match(docs.operatorHandoff, /a287800735d465a41ad9e45d2c7914ab9cc34a26/)
