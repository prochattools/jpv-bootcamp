...
async function main(): Promise<void> {
  ...
  assert.match(docs.roadmap, /984d88c94a9971a180ad94efe1c42bc03022ad92/)
  assert.match(docs.roadmap, /STAGING TECHNICAL IMPLEMENTATION COMPLETE — ACCEPTANCE PENDING EXTERNAL ACTION/)
  assert.match(docs.roadmap, /STAGING HARDENING REMEDIATION REQUIRED/)
  ...
  assert.match(docs.roadmap, /`pnpm test:e2e` passed `148\/148`/)
  ...
  assert.match(docs.operatorHandoff, /984d88c94a9971a180ad94efe1c42bc03022ad92/)
  ...
  assert.match(docs.operatorHandoff, /Migration inventory.*28\/28|Migrations applied.*No/i)
  ...
  assert.match(docs.operatorHandoff, /Launch browser E2E: `pnpm test:e2e` \(`148\/148`, desktop and mobile Chromium/)
  ...
  assert.match(docs.previewReadiness, /STAGING TECHNICAL IMPLEMENTATION COMPLETE — ACCEPTANCE PENDING EXTERNAL ACTION/)
  assert.match(docs.previewReadiness, /STAGING HARDENING REMEDIATION REQUIRED/)
  assert.doesNotMatch(docs.previewReadiness, /STAGING IMPLEMENTATION AND ACCEPTANCE COMPLETE/)
  assert.match(docs.previewReadiness, /984d88c94a9971a180ad94efe1c42bc03022ad92/)
  assert.match(docs.previewReadiness, /30756215188/)
  assert.match(docs.previewReadiness, /DECISION-READY FOR CONTROLLED STAGING APPROVAL AFTER HARDENING/)
  ...
  assert.match(docs.previewReadiness, /`pnpm test:e2e` passed `148\/148`/)
