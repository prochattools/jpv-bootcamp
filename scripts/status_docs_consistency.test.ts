...
async function main(): Promise<void> {
  ...
  assert.match(docs.roadmap, /`d55229f test: enforce programme content readiness` as the current validated implementation baseline/)
  ...
  assert.match(docs.previewReadiness, /STAGING IMPLEMENTATION AND ACCEPTANCE COMPLETE/)
