...
async function main(): Promise<void> {
  ...
  assert.match(docs.statusProcedure, /docs\/client\/JPV_Bootcamp_Platform_Expansion_Go_Live_Plan_v3_5\.docx/)
  ...
  assert.match(docs.roadmap, /Current client truth: `docs\/client\/JPV_Bootcamp_Platform_Expansion_Go_Live_Plan_v3_5\.docx`/)
  ...
  assert.match(docs.roadmap, /historical baseline and `1e5c4ed feat: complete M1-06 launch content views` as the current local readiness baseline/)
  ...
  assert.match(docs.roadmap, /`pnpm test:release` passed `116\/116`/)
  assert.match(docs.roadmap, /`pnpm test:e2e` passed `56\/56`/)
  ...
  assert.match(docs.operatorHandoff, /Current local readiness baseline: `1e5c4ed feat: complete M1-06 launch content views`/)
  ...
  assert.match(docs.operatorHandoff, /Deterministic non-browser release gate: `pnpm test:release` \(`116\/116`\)/)
  assert.match(docs.operatorHandoff, /Launch browser E2E: `pnpm test:e2e` \(`56\/56`\)/)
  ...
  assert.match(docs.previewReadiness, /`pnpm test:release` passed `116\/116`/)
  assert.match(docs.previewReadiness, /`pnpm test:e2e` passed `56\/56`/)
