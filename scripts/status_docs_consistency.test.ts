...
async function main(): Promise<void> {
  ...
  assert.match(docs.roadmap, /34c6e7550bd2103a05c4414a2f582787dc15bf08/)
  ...
  assert.match(docs.operatorHandoff, /34c6e7550bd2103a05c4414a2f582787dc15bf08/)
  ...
  assert.match(docs.previewReadiness, /34c6e7550bd2103a05c4414a2f582787dc15bf08/)
  assert.match(docs.previewReadiness, /30719336990/)
