...
async function main(): Promise<void> {
  ...
  assert.match(docs.roadmap, /3a6613498241c5dd71761c26c3b1e790764db1d5/)
  assert.match(docs.roadmap, /30756831212/)
  ...
  assert.match(docs.operatorHandoff, /3a6613498241c5dd71761c26c3b1e790764db1d5/)
  ...
  assert.match(docs.previewReadiness, /3a6613498241c5dd71761c26c3b1e790764db1d5/)
  assert.match(docs.previewReadiness, /30756831212/)
