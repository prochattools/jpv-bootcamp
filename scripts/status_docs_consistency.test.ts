...
async function main(): Promise<void> {
  ...
  assert.match(docs.roadmap, /~71%/)
  assert.match(docs.roadmap, /~95%/)
  assert.match(docs.roadmap, /~88%/)
  assert.match(docs.roadmap, /~90%/)
  assert.match(docs.roadmap, /~52%/)
  ...
  assert.match(docs.operatorHandoff, /Last recorded validated baseline before this status update: `3bc8b7e docs: finalize operator handoff evidence review`/)
  ...
  assert.match(docs.reviewPacket, /Latest verified branch tip before this pass: `3bc8b7e docs: finalize operator handoff evidence review`/)
