...
// Reject unknown keys
const ALLOWED_KEYS = new Set(['version','resultCode','blockerCodes','branch','commit','schema','environment','targetId','appliedPayloadCount','expectedPendingMigration','expectedPendingMigrationIsOnlyMissing','unexpectedPayloadCount','duplicatePayloadCount','malformedPayloadCount','prismaHealthy'])
