...
export const RELEASE_TEST_MANIFEST: ReleaseTestEntry[] = [
  ...
  test('stripe.mighty-cutover-runner', 'Stripe checkout, webhook, schedule, invoice, recovery, refund, and dispute handling', 'src/lib/mighty/cutoverRunner.test.ts', 'Protects bounded batch execution, checkpoint/resume, idempotent rerun, stop-on-error, rollback, and review skips with synthetic provider adapters.', 'A future cutover batch can continue after an error, repeat a mutation, or bypass an identity review.', 'readiness'),
