...
export const RELEASE_TEST_MANIFEST: ReleaseTestEntry[] = [
  ...
  test('stripe.mighty-cutover-manifest-agreement', 'Stripe checkout, webhook, schedule, invoice, recovery, refund, and dispute handling', 'scripts/mighty/cutoverManifestAgreement.test.ts', 'Protects exact agreement between the checked-in human manifest and the application rehearsal action set.', 'The operator manifest can drift from the application output and authorize the wrong future action.', 'readiness'),
