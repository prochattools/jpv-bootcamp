...
assert.match(payloadMigrationRunner, /SYSTEM_DATABASE_URL/)
assert.match(payloadMigrationRunner, /SYSTEM_DATABASE_URL schema must be public/)
assert.match(payloadMigrationRunner, /return \{ databaseUrl: systemDatabaseUrl, schema: expected.schema \}/)
