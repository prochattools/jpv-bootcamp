...
export async function JPVBillingOverview() {
  try {
    ...
    const members = membersResult.docs as unknown as Doc[]
    const accounts = accountsResult.docs as unknown as Doc[]
    const subscriptions = subscriptionsResult.docs as unknown as Doc[]
    const payments = paymentsResult.docs as unknown as Doc[]
