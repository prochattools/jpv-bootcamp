...
export function LegacyLessonRichText({
  ...
  return (
    <div className='jpv-rich-text lesson-body mx-auto mt-8 max-w-4xl text-sm leading-7 text-jpv-ink [&_h2]:mb-2 [&_h2]:mt-6 [&_h2]:text-xl [&_h2]:font-semibold [&_h3]:mb-2 [&_h3]:mt-4 [&_h3]:text-lg [&_h3]:font-semibold [&_a]:text-jpv-brand-deep [&_a]:underline [&_a]:underline-offset-4 [&_blockquote]:border-l-4 [&_blockquote]:border-jpv-border [&_blockquote]:pl-4 [&_blockquote]:italic [&_img]:my-5 [&_img]:h-auto [&_img]:max-w-full [&_li]:ml-4 [&_li]:list-disc [&_ol_li]:list-decimal [&_p]:mb-3 [&_.legacy-html-fragment]:overflow-x-auto [&_.legacy-html-fragment_table]:my-5 [&_.legacy-html-fragment_table]:w-full [&_.legacy-html-fragment_table]:min-w-[720px] [&_.legacy-html-fragment_table]:border-collapse [&_.legacy-html-fragment_td]:align-top [&_.legacy-html-fragment_td]:border [&_.legacy-html-fragment_td]:border-jpv-border [&_.legacy-html-fragment_td]:p-3 [&_.legacy-html-fragment_th]:border [&_.legacy-html-fragment_th]:border-jpv-border [&_.legacy-html-fragment_th]:bg-jpv-surface [&_.legacy-html-fragment_th]:p-3 [&_.legacy-html-fragment_th]:text-left [&_.legacy-html-fragment_th]:font-semibold'>
