		...
		<div className="rounded-3xl bg-jpv-ink p-6 shadow-[0_8px_30px_rgba(0,0,0,0.3)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_20px_50px_rgba(0,0,0,0.45)]">
			...
			<div className="mt-6 flex flex-wrap gap-3">
				<button
					...
					className="min-h-11 rounded-jpv-action border border-jpv-canvas px-4 py-2 text-sm font-semibold text-jpv-canvas transition-colors hover:bg-jpv-canvas hover:text-jpv-ink disabled:cursor-not-allowed disabled:border-jpv-canvas/40 disabled:text-jpv-canvas/60 disabled:opacity-60 disabled:hover:bg-transparent"
				>
