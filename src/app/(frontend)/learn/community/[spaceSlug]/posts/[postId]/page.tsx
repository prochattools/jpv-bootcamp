    ...
    <PortalShell memberEmail={email}>
      <main className='mx-auto max-w-4xl px-6 py-10 lg:px-10 lg:py-14'>
        <Link
          ...
          href={`/learn/community/${encodeURIComponent(post.space.slug)}`}
        >
          Back to {post.space.name}
        </Link>

        <article className='mt-6 overflow-hidden rounded-[28px] border border-[#153f2e]/10 bg-white shadow-[0_24px_70px_rgba(31,52,43,0.1)]'>
