...
export default async function PortalCommunityPage() {
  ...
  return (
    <div className='mx-auto max-w-7xl space-y-14'>
      ...
      <section>
        <div>
          <p className='text-xs font-bold uppercase tracking-[0.2em] text-[#8a7450]'>Shared files</p>
          <h2 className='mt-2 text-3xl font-bold tracking-tight text-[#153f2e]'>Community resources</h2>
      ...
      <section>
        <div>
          <p className='text-xs font-bold uppercase tracking-[0.2em] text-[#8a7450]'>Announcements</p>
      ...
      <section>
        <div className='flex flex-col justify-between gap-4 sm:flex-row sm:items-end'>
          <div>
            <p className='text-xs font-bold uppercase tracking-[0.2em] text-[#8a7450]'>Community spaces</p>
