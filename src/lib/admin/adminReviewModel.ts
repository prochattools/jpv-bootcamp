...
const SECTIONS: AdminReviewSection[] = [
  ...
  },
  {
    slug: 'member-portal',
    title: 'Member Portal',
    summary: 'Authenticated portal entry at /portal (requires Payload DB + auth). Canonical member/student gateway.',
    description: 'The /portal route is the canonical member/student entry point. It requires real Payload authentication and DB access. Members access courses, community, billing, account, and support/pay-it-forward through this portal.',
    status: 'blocked',
    ownerLabel: 'MVP owner',
    href: '/portal',
    blockerCount: 1,
