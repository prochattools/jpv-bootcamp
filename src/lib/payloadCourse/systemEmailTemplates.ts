...
const templates: Record<string, PayloadDocument> = {
  ...
  [BILLING_PAYMENT_FAILED_TEMPLATE_KEY]: brandedTemplate({
    ...
    preheader: 'Your JPV Mighty access is paused until the payment is resolved.',
    heading: 'Access paused — payment needs attention',
    paragraphs: [
      'We could not process a recent payment for your JPV Bootcamp membership.',
      'Your JPV Mighty access has been paused because the payment could not be completed.',
      'Resolve the payment below. When Stripe confirms the payment, your access will be restored automatically.',
    ],
