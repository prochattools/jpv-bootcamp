...
const PREVIEW_MIGRATION_METADATA = [
  ...
  { purpose: 'Expose Stripe invoice totals, attempts, hosted links, and next-payment timing in Payload billing projections.', rollbackRisk: 'reversible', verificationChecks: ['registry-match', 'ordered-exactly', 'billing-invoice-visibility'] },
  ...
  { purpose: 'Create the missing Payload relationship table for membership-support reverse relationships.', rollbackRisk: 'reversible', verificationChecks: ['registry-match', 'ordered-exactly', 'membership-support-relationships'] },
  { purpose: 'Align legacy membership-support relationship columns and review enums with the current Payload runtime contract.', rollbackRisk: 'reversible', verificationChecks: ['registry-match', 'ordered-exactly', 'membership-support-relationship-alignment'] },
  ...
  { purpose: 'Add current membership-support Stripe shadow states while preserving historical state values.', rollbackRisk: 'reversible', verificationChecks: ['registry-match', 'ordered-exactly', 'membership-shadow-state-alignment'] },
