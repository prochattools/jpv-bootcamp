# Graph Report - /Users/Office/Repos/prochattools/clients/jc-citadel/jpv-bootcamp  (2026-06-15)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 1000 nodes · 1728 edges · 126 communities (105 shown, 21 thin omitted)
...
- [[_COMMUNITY_Postgres Database|Postgres Database]]
...
Cohesion: 0.06
Nodes (56): ApprovePayload, parsePayload(), POST(), GET(), PageProps, CheckoutPayload, POST(), ClaimOutcome (+48 more)

### Community 1 - "User Provisioning"
Cohesion: 0.07
Nodes (61): ACTIVE_STATUSES, buildEmailSendKey(), buildWpActions(), EmailSendSource, EmailSource, evaluateEmailNotification(), findProvisioningRecord(), getCheckoutSessionLineItemInfo() (+53 more)

### Community 2 - "Site Layout"
Cohesion: 0.07
Nodes (49): EnvKey, getEnv(), getEnvAny(), getEnvBoolean(), getEnvOrDefault(), getOpsConfig(), getServerConfig(), getStripeConfig() (+41 more)

### Community 3 - "Configuration Management"
Cohesion: 0.10
Nodes (37): buildReturnUrl(), extractBearerToken(), GET(), getActiveMembershipSubscriptionForCustomer(), getCurrentPlanFromSubscription(), getPriceIdForPlan(), getSubscriptionItemId(), isPricingPlanKey() (+29 more)
...
Cohesion: 0.06
Nodes (16): EmailFormProps, data, nav_links1, nav_links2, nav_links, avatars, NavLink, PropsTypes (+8 more)
...
Cohesion: 0.19
Nodes (17): buildSessionCookieOptions(), PARTNERS_MAX_TOKEN_LENGTH, sanitizePartnersToken(), ALLOWED_HOSTS, normalizePath(), PARTNERS_DEFAULT_PATH, sanitizePathOnly(), sanitizeRefPath() (+9 more)
...
Cohesion: 0.22
Nodes (5): Avatar, AvatarFallback, AvatarImage, Switch, TooltipContent
...
Cohesion: 0.32
Nodes (7): cn(), DialogContent, DialogDescription, DialogFooter(), DialogHeader(), DialogOverlay, DialogTitle
...
## Knowledge Gaps
- **222 isolated node(s):** `{ Client }`, `fs`, `path`, `{ Client }`, `fs` (+217 more)
...
- **Why does `redactEmail()` connect `Data Redaction` to `Sponsored Claim Flow`, `User Provisioning`, `External Dependencies`, `Marketing Content`, `TypeScript Config`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `getStripe()` connect `User Provisioning` to `Sponsored Claim Flow`, `Marketing Content`, `Configuration Management`, `External Dependencies`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `cn()` connect `Tailwind Config` to `Billing Portal Flow`, `Blog Layout`, `Development Utilities`, `UI Dialog Components`, `Subscription Management`, `Billing Portal Logic`, `Tenant Initialization`, `Deployment Scripts`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
