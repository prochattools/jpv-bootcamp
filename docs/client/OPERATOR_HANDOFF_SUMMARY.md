...
- **Rooms feature candidate — 2026-08-30:** isolated branch `feature/member-portal-rooms`. Deterministic release gate: `pnpm test:release` (`174/174`). This is local/CI validation only and does not constitute staging or production evidence.
