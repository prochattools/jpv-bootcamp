...
- Deterministic release gate: `pnpm test:release` (`168/168`) — includes the account-action hardening-status guard, staging migration plan workflow contract, and environment configurator dry-run/apply guard test
