...
- Deterministic release gate: `pnpm test:release` (`169/169`) — includes the account-action hardening-status guard, staging migration plan workflow contract, environment configurator dry-run/apply guard test, and portal admin source structure and behavioral contract verification
