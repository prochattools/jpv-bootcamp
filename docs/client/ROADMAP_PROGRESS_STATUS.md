...
- **Rooms feature candidate — 2026-08-30:** isolated branch `feature/member-portal-rooms`; `pnpm test:release` passed `176/176`. This is local/CI validation only and does not constitute staging or production evidence.
