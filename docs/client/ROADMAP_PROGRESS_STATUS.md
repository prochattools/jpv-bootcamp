...
Operator runs `pnpm evidence:create`, completes approval/staging/provider evidence manually, then validates it with `pnpm evidence:validate` without applying migrations.
