...
- **Frozen implementation baseline:** `b771cfca4ab6d2bcaa76f6dc2d2420c114082dd8` is pushed and locally validated; verify any later documentation-only tip before staging; exact-SHA deployment and acceptance remain separate, unauthorized gates.
