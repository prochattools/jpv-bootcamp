...
- **Repository gate:** after cleanup, `pnpm test:release` passed `172/172`; focused browser checks passed `60/60`; full browser E2E passed `148/148` with 60 declared skips. The shared `#A89A80` contrast failures are corrected.
