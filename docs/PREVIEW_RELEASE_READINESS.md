...
- **Repository gate:** after cleanup, `pnpm test:release` passed `170/170`; focused browser checks passed `60/60`; full browser E2E passed `148/148` with 60 declared skips. The shared `#A89A80` contrast failures are corrected.
